    ...
    >
      ...
      <section className="relative flex flex-col items-center justify-center min-h-screen text-center px-6 py-24 overflow-hidden">
        ...
        <div className="relative z-10 max-w-3xl mx-auto flex flex-col items-center gap-8">
          ...
          <div
            style={{ position: "relative", width: "156px", height: "131px" }}
          >
            <svg
          ...
          <div className="hero-reveal flex flex-col items-center gap-5 w-full">
            ...
            <div style={{ position: "relative" }}>
              <Image
                src="/real-output.png"
                alt="findings sample output"
                width={800}
                height={215}
                className="object-contain border rounded-lg "
                style={{ boxShadow: "inset 0 0 0 10px rgba(168,153,104,0.3)" }}
              />
              ...
              <div
                style={{
                  position: "absolute",
                  inset: 0,
                  boxShadow: "inset 0 0 0 3px rgba(168,153,104,0.3)",
                  zIndex: 1,
                  borderRadius: "8px",
                  pointerEvents: "none",
                }}
        ...
        <div className="max-w-5xl mx-auto grid md:grid-cols-2 gap-16 items-center">
          ...
          <div className="flex flex-col gap-6">
            ...
            <h2
              ...
              style={{ color: "var(--foreground)" }}
            >
              The data room shows you what the seller chose to show you. The
              commit history doesn&apos;t have a curator.
            </h2>
            <p
      ...
      >
        <div className="max-w-xl mx-auto flex flex-col items-center text-center gap-0">
          <p
            className="text-2xl md:text-3xl font-semibold leading-snug w-full"
            style={{
              color: "#a09a94",
              paddingBottom: "40px",
              borderBottom: "1px solid var(--vestige-purple)",
            }}
          >
            <span style={{ color: "var(--vestige-crystal)" }}>Vestige</span>{" "}
            reads the entire repository and sorts the information to give you
            the history of how this codebase became what it is today.
          </p>
          <p
            className="text-2xl md:text-3xl font-semibold leading-snug w-full"
            style={{
          ...
          <p
            className="text-2xl md:text-3xl font-semibold leading-snug w-full"
            style={{ color: "#a09a94", paddingTop: "40px" }}
          >
            The story is a diagram that aids in finding and assessing the risks.
            Your report is what{" "}
            <span style={{ color: "var(--vestige-crystal)" }}>verifies</span>{" "}
            where this code is fragile.
          </p>
        </div>
      </section>
      ...
      >
        <div className="max-w-2xl mx-auto flex flex-col items-center gap-8">
          ...
          >
            &ldquo;We won&apos;t tell you if the deal works out. We&apos;ll make
            sure you&apos;ve seen the whole history before you decide.&rdquo;
          </h2>
          <p
          ...
          >
            ...
            give you is complete coverage of the commit history, every commit
            reviewed and categorized, not a sample, not a highlight reel
            selected by the seller&apos;s engineering team. The picture is yours
            to interpret. We just make sure it&apos;s the whole one.
          </p>
        </div>
      </section>
      ...
      <section className="px-6 py-24" style={{ background: "#111111" }}>
        <div className="max-w-6xl mx-auto">
          ...
          <div className="grid md:grid-cols-2 gap-x-10 gap-y-4">
            ...
            {/* Row 3: arrows */}
            <div className="text-center text-lg" style={{ color: "#333" }}>
              ↓
            </div>
            <div className="text-center text-lg" style={{ color: "#333" }}>
              ↓
            ...
            >
              ...
              <p className="text-xs font-mono" style={{ color: "#c0783a" }}>
                ⚠ Three patches that only make sense if something broke in
                production.
              </p>
            </div>
